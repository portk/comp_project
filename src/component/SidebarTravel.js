...
import nullImg1 from '../img/nullImg1.png';
        ...
        <div className='sidebarTravel'>
            ...
            <div className='sidebarTravelChoiceOWrapWrap'>
                {/* <div className='sidebarTravelChoiceOPlace'>
                    <div className='sidebarTravelChoiceOPlaceTitle'>지역입니다</div>
                </div> */}
                ...
                <div>
                    <button onClick={()=>{const cat = "자연관광지";tourcategory(cat)}}>1</button>
                    <button onClick={()=>{const cat = "역사관광지";tourcategory(cat)}}>2</button>
                    <button onClick={()=>{const cat = "체험관광지";tourcategory(cat)}}>3</button>
                    <button onClick={()=>{const cat = "산업관광지";tourcategory(cat)}}>4</button>
                    <button onClick={()=>{const cat = "건축/조형물";tourcategory(cat)}}>5</button>
                    <button onClick={()=>{const cat = "생활문화";tourcategory(cat)}}>6</button>
                    <button onClick={()=>{const cat = "레포츠";tourcategory(cat)}}>7</button>
                </div>
