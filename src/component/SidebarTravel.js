...
function SidebarTravel() {
    ...
    const locationCongestResult = () => {
        ...
        if (locationCongest === "green") {
            setCongest("원활");
            sidebarTravelChoiceOPlaceCongestion.style.backgroundColor = locationCongest;
        } else if (locationCongest === "lightgreen") {
            setCongest("조금원활")
            sidebarTravelChoiceOPlaceCongestion.style.backgroundColor = locationCongest;
        } else if (locationCongest === "yellow") {
            setCongest("보통")
            sidebarTravelChoiceOPlaceCongestion.style.backgroundColor = locationCongest;
        } else if (locationCongest === "orange") {
            setCongest("조금혼잡")
            sidebarTravelChoiceOPlaceCongestion.style.backgroundColor = locationCongest;
        } else if (locationCongest === "red") {
            setCongest("혼잡")
            sidebarTravelChoiceOPlaceCongestion.style.backgroundColor = locationCongest;
        } else {
            setCongest("정보없음")
            sidebarTravelChoiceOPlaceCongestion.style.backgroundColor = "white"
        }
    }
                ...
                <div className='sidebarTravelChoiceOWrap'>
                    ...
                    <div className='sidebarTravelChoiceO'>
                        <div className='sidebarTravelChoice1'>
                            <div className='sidebarTravelChoice1Wrap' onClick={()=>{sidebarTravelChoice1WrapSvgColor();tourdata();setLst();setInfoSidebarOpenClose();sidebarTravelChoice1CategoryShow();sidebarTravelListO1Click();}}>
                        ...
                        <div className='sidebarTravelChoice2'>
                            <div className='sidebarTravelChoice2Wrap' onClick={()=>{sidebarTravelChoice2WrapSvgColor();festivaldata();setLst();setInfoSidebarOpenClose();sidebarTravelChoice1CategoryShowX();sidebarTravelListO2Click();}}>
                                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width='20' height='20'>
                        ...
                        <div className='sidebarTravelChoice3'>
                            <div className='sidebarTravelChoice3Wrap' onClick={()=>{sidebarTravelChoice3WrapSvgColor();accommodationdata();setLst();setInfoSidebarOpenClose();sidebarTravelChoice1CategoryShowX();sidebarTravelListO3Click();}}>
