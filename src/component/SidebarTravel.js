...
function SidebarTravel() {
    const {sigid,setTourPlace,setFestival,setAccommodation,setSidebarClick} = useContext(Context)
            ...
            <div className='sidebarTravelChoice'>
                ...
                <div className='sidebarTravelChoiceO'>
                    <div className='sidebarTravelChoice1'>
                        <div className='sidebarTravelChoice1Wrap' onClick={()=>{sidebarTravelChoice1WrapSvgColor();tourdata();}}>
                    ...
                    <div className='sidebarTravelChoice2'>
                        <div className='sidebarTravelChoice2Wrap' onClick={()=>{sidebarTravelChoice2WrapSvgColor();festivaldata();}}>
                            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" width='23' height='23'>
                    ...
                    <div className='sidebarTravelChoice3'>
                        <div className='sidebarTravelChoice3Wrap' onClick={()=>{sidebarTravelChoice3WrapSvgColor();accommodationdata();}}>
